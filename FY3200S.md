...
-   **`x`:** Waveform identifier.

-   **Waveform Identifiers (`x`):**
    ...
    -   `9`: Periodic Random Noise

    -   `10`: ECG

    -   `11`: Trapezoidal Pulse

    -   `12`: Sinc Pulse

    -   `13`: Narrow Pulse

    -   `14`: Gauss White Noise
...
-   **Main Channel:** `boxxx.x + 0x0a`

-   **Deputy Channel:** `doxxx.x + 0x0a`

-   **`xxx.x`:** Offset value in Volts (can be negative).
